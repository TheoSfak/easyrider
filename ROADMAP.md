...
### v3.87.1 — Ενημέρωση Έκδοσης Service Worker
- Το `CACHE_VERSION` του service worker (PWA) είχε μείνει σε παλιά τιμή από την εποχή του v3.70.10, με αποτέλεσμα οι παλιές cached εκδόσεις να μην καθαρίζονται σωστά σε κάθε νέο release. Ενημερώθηκε ώστε να ακολουθεί την τρέχουσα έκδοση.
