            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php if ($step == '1'): ?>
                        ...
                        <p class="text-muted">Ανεβάστε ένα CSV αρχείο με τα μέλη που θέλετε να εισάγετε.</p>
                        
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i>
                            <strong>Μορφή αρχείου:</strong> CSV με headers (υποχρεωτικά: <strong>Όνομα, Email, Τμήμα ID, Ρόλος</strong>).<br>
                            Προαιρετικά: Τηλέφωνο, Ταυτότητα, ΑΜΚΑ, Δίπλωμα Οδήγησης, Πινακίδα Οχήματος, Αρ. Μητρώου Λέσχης, Τύπος Μέλους, Διεύθυνση, Πόλη, ΤΚ, Επαφή Έκτακτης Ανάγκης, Τηλ. Επαφής Έκτακτης, Ομάδα Αίματος, Βιογραφικό, Ιατρικές Σημειώσεις, Διαθ. Καθημερινές, Διαθ. Σαββ/κα, Διαθ. Βράδια, Έχει Δίπλωμα Οδήγησης, Έχει Πρώτες Βοήθειες.<br>
                            <strong>Τύπος Μέλους:</strong> MEMBER / TRAINEE_RESCUER / RESCUER<br>
                    ...
                    <?php elseif ($step == '4'): ?>
                        ...
                        <?php if ($results['success'] > 0): ?>
                            <div class="alert alert-success">
                                <i class="bi bi-check-circle"></i> 
                                <strong>Επιτυχία!</strong> Εισήχθησαν <?= $results['success'] ?> μέλη.
                            </div>
                            
                            <?php if (!empty($results['passwords'])): ?>
                                <div class="alert alert-warning">
                                    <h6><i class="bi bi-key"></i> Κωδικοί Πρόσβασης</h6>
                                    <p>Αποθηκεύστε τους κωδικούς και στείλτε τους στα μέλη:</p>
                                    <div class="table-responsive">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?= SITE_URL ?>/members.php" class="btn btn-primary">
                                <i class="bi bi-people"></i> Προβολή Μελών
                            </a>
                            <a href="import-members.php" class="btn btn-secondary">
