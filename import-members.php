                ...
                <div class="card-body">
                    ...
                    <?php if ($step == '1'): ?>
                        ...
                        <div class="alert alert-info">
                            ...
                            Προαιρετικά: Τηλέφωνο, Ταυτότητα, ΑΜΚΑ, Δίπλωμα Οδήγησης, Πινακίδα Οχήματος, Παντελόνι, Μπλούζα, Μπλάκετ, Fleece, Μητρώο Επίδρασης, Μητρώο ΓΓΠΠ, Τύπος Μέλους, Διεύθυνση, Πόλη, ΤΚ, Επαφή Έκτακτης Ανάγκης, Τηλ. Επαφής Έκτακτης, Ομάδα Αίματος, Βιογραφικό, Ιατρικές Σημειώσεις, Διαθ. Καθημερινές, Διαθ. Σαββ/κα, Διαθ. Βράδια, Έχει Δίπλωμα Οδήγησης, Έχει Πρώτες Βοήθειες.<br>
