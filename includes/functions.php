...
/**
 * Add whole months to an ISO date, clamping to the last valid day of the target month.
 */
function addMonthsToDate($date, $months) {
    ...
    $targetMonthIndex = ($month - 1) + $months;
    $targetYear = $year + intdiv($targetMonthIndex, 12);
    $targetMonth = ($targetMonthIndex % 12) + 1;
    $targetDay = min($day, cal_days_in_month(CAL_GREGORIAN, $targetMonth, $targetYear));
