...
function exportMembersToCsv($filters = []) {
    ...
    fputcsv($out, [
        ...
        'Δίπλωμα Οδήγησης', 'Πινακίδα Οχήματος', 'Αρ. Μητρώου Λέσχης',
        'Ρόλος', 'Τύπος Μέλους', 'Ενεργός', 'Πόντοι',
        'Διεύθυνση', 'Πόλη', 'ΤΚ',
...
function exportParticipationsToCsv($filters = []) {
    ...
    fputcsv($output, [
        ...
        'Email',
        'Αποστολή',
        'Έναρξη Κύκλου Εγγραφών',
        'Λήξη Κύκλου Εγγραφών',
        'Κατάσταση',
        'Παρουσία',
        'Ώρες',
        'Σημειώσεις Μέλους',
