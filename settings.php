<?php
/**
 * EasyRide - Settings (SMTP, Email Templates, Notifications)
 */
...
function runHealthChecks() {
    ...
    try {
        ...
        $stats[] = ['label' => 'Δράσεις κατά κατάσταση', 'value' => $missionStr ?: 'Δεν υπάρχουν', 'status' => 'ok', 'detail' => ''];
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="resendMission">
                            <strong>Ξαναστείλε Δράση αν δεν έχει συμπληρωθεί</strong>
                        </label>
                    </div>
...
0 9 * * * /usr/bin/php /home/USERNAME/public_html/easyride/cron_incomplete_missions.php

# Υπενθυμίσεις εργασιών (κάθε 6 ώρες)
0 */6 * * * /usr/bin/php /home/USERNAME/public_html/easyride/cron_task_reminders.php

# Ειδοποιήσεις λήξης συνδρομών (08:30)
30 8 * * * /usr/bin/php /home/USERNAME/public_html/easyride/cron_citizen_cert_expiry.php</div>
                    <small class="text-muted mt-2 d-block">
                        <i class="bi bi-info-circle me-1"></i>Αντικαταστήστε <code>USERNAME</code> με το username του hosting σας και 
                        <code>/home/USERNAME/public_html/easyride/</code> με το πλήρες path εγκατάστασης.
                    </small>
                </div>
            </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p class="text-muted mb-3">
                    <i class="bi bi-info-circle me-1"></i>
                    Οι παρακάτω εργασίες είναι οι ενεργές αυτοματοποιήσεις του EasyRide και εκτελούνται μέσω του <code>cron_daily.php</code>.
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="bg-dark text-light p-2 rounded mb-3" style="font-size: 12px;">
                    <code class="text-light">php C:\xampp\htdocs\easyride\cron_daily.php</code>
                </div>
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-1">
                        <i class="bi bi-gear me-1"></i>
                        <strong>Ώρες πριν ελλιπείς δράσεις:</strong> <?= h($settings['resend_mission_hours_before'] ?? '48') ?>h
                        <a href="settings.php?tab=general" class="ms-1"><i class="bi bi-pencil-square"></i></a>
                    </li>
                    <li class="mb-1">
                        <i class="bi bi-gear me-1"></i>
                        <strong>Ειδοποιήσεις ελλιπών δράσεων:</strong>
...
<div class="row">
    <div class="col-lg-7">
        <form method="post">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-bell me-1"></i>Ειδοποιήσεις Λήξης Συνδρομών</h5>
                </div>
                <div class="card-body">
                    <div class="form-check form-switch mb-4">
                        ...
                        <small class="text-muted d-block">Αν είναι ενεργό, το σύστημα θα στέλνει email ειδοποιήσεις πριν τη λήξη συνδρομών.</small>
                    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body d-grid gap-2">
                ...
                <a href="citizen-certificate-types.php" class="btn btn-outline-primary">
                    <i class="bi bi-tags me-1"></i>Τύποι Συνδρομών
                </a>
            </div>
        </div>
