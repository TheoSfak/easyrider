    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <label class="form-label fw-semibold">Περιεχόμενο email <span class="text-danger">*</span></label>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <small class="text-muted">Αυτά τα email λαμβάνουν το δελτίο ανεξάρτητα από τα φίλτρα ρόλων.</small>
                </div>
            </div>
