<?php
/**
 * EasyRide - Custom Role Create/Edit Form
 * System Admin only.
 */
...
$currentPerms   = filterCurrentPermissionSlugs($currentPerms);
...
if (isPost()) {
    ...
    $form['permissions'] = filterCurrentPermissionSlugs((array) ($_POST['permissions'] ?? []));
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info py-2 mb-3">
                            ...
                            Αυτές οι ρυθμίσεις ισχύουν για <strong>μέλη</strong> με τον επιλεγμένο ρόλο.
                        </div>
