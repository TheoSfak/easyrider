<?php
/**
 * EasyRide - Custom Roles Management
...
$roles = dbFetchAll(
    "SELECT cr.*,
            GROUP_CONCAT(DISTINCT crp.page_slug ORDER BY crp.page_slug SEPARATOR ',') AS permission_slugs,
            ...
            <div class="row g-2">
                ...
                <div class="col-auto">
                    <span class="badge bg-secondary fs-6 px-3 py-2">
                        <i class="bi bi-person me-1"></i>Μέλος
                    </span>
                </div>
            </div>
            <small class="text-muted d-block mt-2">Οι ενσωματωμένοι ρόλοι δεν μπορούν να τροποποιηθούν. Οι προσαρμοσμένοι ρόλοι παρακάτω ισχύουν για χρήστες με βασικό ρόλο «Μέλος».</small>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-6">
                                    <div class="text-center bg-light rounded p-2">
                                        <?php
                                        $granted = filterCurrentPermissionSlugs(
                                            $role['permission_slugs'] !== null && $role['permission_slugs'] !== ''
                                                ? explode(',', $role['permission_slugs'])
                                                : []
                                        );
                                        ?>
                                        <div class="fw-bold fs-5"><?= count($granted) ?>/<?= $totalPerms ?></div>
        ...
        <form method="post" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="deleteUserWarning" class="alert alert-warning d-none">
                    ...
                    <strong id="deleteUserCount"></strong> χρήστες έχουν αυτόν τον ρόλο. Θα γίνουν απλά μέλη χωρίς ειδικά δικαιώματα.
                </div>
